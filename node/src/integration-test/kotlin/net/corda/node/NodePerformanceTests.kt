...
class NodePerformanceTests {
    ...
    @Test
    fun `self pay rate`() {
        driver(startNodesInProcess = true, notaries = listOf(NotaryNode.Single(DUMMY_NOTARY.name, validating = true)), extraCordappPackagesToScan = listOf("net.corda.finance")) {
